define(["dojo/_base/declare", "dojo/_base/lang", "dojo/dom-attr", "dijit/_WidgetBase", "dijit/_Container", "dijit/_Contained", "./_ScrollableMixin", "./_layoutMixin"], 
function(declare, lang, dattr, WidgetBase, Container, Contained, ScrollableMixin, layoutMixin){
	return declare("dojox.application.widgets.container", [WidgetBase, Container, Contained, layoutMixin], {
