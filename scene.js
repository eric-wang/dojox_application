define(["dojo/_base/kernel",
	...
	"./bind",
    "./layout/utils"], 
	function(dojo,win,declare,connect, array,deferred,dlang,has,dstyle,dgeometry,cls,dconstruct,dattr,query,dijit,dojox,WidgetBase,Templated,WidgetsInTemplate,transit, model, baseView, bind,layoutUtils){
