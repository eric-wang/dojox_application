...
"dojo/_base/declare",
"dojo/on"],
function(dojo, dlang, declare, listen){
	return declare(null, {
		...
		onStartTransition: function(evt){
			...
			console.log("transition", target, evt.detail.href, history.state);
		...
		proceedTransition: function(transitionEvt){
			...
			dojo.when(this.transition(transitionEvt.target, transitionEvt.opts), dojo.hitch(this, function(){
